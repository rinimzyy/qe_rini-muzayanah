...
Mobile.tap(findTestObject('android.widget.Button - REGISTER (6)'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('android.widget.TextView - Enter Valid Email', [('variable') : '']), 0)
